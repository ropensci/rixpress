...
## Analyzing the mtcars dataset using R only
...
- as mentioned in the `vignette("a-intro-concepts")`, functions are executed in
  a hermetic sandbox: if they need access to some external resource, the build
...
- if you have proprietary R packages, you will need to include them in the Nix
  ...
  your packages, open an issue [on the rix GitHub
  repository](https://github.com/ropensci/rix/issues).
